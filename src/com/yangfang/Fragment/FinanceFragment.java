...
import com.yangfang.http.protocal.FinanceProtocol;
...
public class FinanceFragment extends BaseFragment{
	...
	public View onCreateSuccessView() {
		...
		view.setAdapter(new FinanceAdapter(data));
	...
	public ResultState onLoad() {
		FinanceProtocol protocol = new FinanceProtocol();
		data = protocol.getData();
		return check(data);
	}
	
	class FinanceAdapter extends MyBaseAdapter<News>{

		public FinanceAdapter(ArrayList<News> data) {
			super(data);
		}
