...
import com.yangfang.http.protocal.ScienceProtocol;
...
public class ScienceFragment extends BaseFragment{
	...
	public View onCreateSuccessView() {
		...
		view.setAdapter(new ScienceAdapter(data));
	...
	public ResultState onLoad() {
		ScienceProtocol protocol = new ScienceProtocol();
		data = protocol.getData();
		return check(data);
	}
	
	class ScienceAdapter extends MyBaseAdapter<News>{

		public ScienceAdapter(ArrayList<News> data) {
			super(data);
		}
