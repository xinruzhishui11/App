...
import com.yangfang.http.protocal.FashionProtocol;
...
public class FashionFragment extends BaseFragment{
	...
	public View onCreateSuccessView() {
		...
		view.setAdapter(new FashionAdapter(data));
	...
	public ResultState onLoad() {
		FashionProtocol protocol = new FashionProtocol();
		data = protocol.getData();
		return check(data);
	}
	
	class FashionAdapter extends MyBaseAdapter<News>{

		public FashionAdapter(ArrayList<News> data) {
			super(data);
		}
